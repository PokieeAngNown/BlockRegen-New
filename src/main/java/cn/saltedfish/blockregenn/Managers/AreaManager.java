...
public class AreaManager {
    ...
    private static final File regenAreaListFile = new File(BlockRegenN.getPlugin().getDataFolder(), "regenAreaList.yml");
    ...
    public static @NotNull String getAreaInfo(String areaName) {
        ...
        return BlockRegenN.getLanguage("Area.Info")
    ...
    public static void writeInformation(String areaName){
        ...
        File file = new File(BlockRegenN.getPlugin().getDataFolder() + "/data", areaName + ".json");
